...
//         const res = await axios.get("http://localhost:5000/api/doctors/approval-status", {
...
//   return (
//     <div className="flex justify-center items-center p-8 min-h-screen bg-[#f4f7fa]">
//       {status === "approved" ? (
//         <div
//         className="bg-white border border-gray-300 shadow-lg rounded-2xl p-10 max-w-2xl text-center"
//         ref={certificateRef}
//         >
...
//             src={doctor?.imageUrl}
//             alt="Doctor"
//             className="w-24 h-24 rounded-full object-cover mx-auto mb-4 border-2 border-gray-300 shadow-md"
//           />

//           <p className="text-lg text-gray-800 mb-6">
//             is officially approved by{" "}
//             <strong className="font-semibold">Health Consultation</strong> to consult
//             patients.
//           </p>
...
//           <div className="flex justify-between items-center mt-8 px-4 flex-wrap gap-4">
...
//   className="bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white px-5 py-3 font-semibold rounded-lg shadow-md inline-flex items-center gap-2 text-base transform transition-transform duration-200 hover:scale-105"
// >
...
//         </div>
//       ) : (
//         <div className="bg-[#fffbea] border-l-4 border-yellow-400 shadow-lg p-6 rounded-xl w-full max-w-xl text-center">
//           <h2 className="text-2xl font-semibold text-yellow-600 mb-4">
//             Approval Pending
//           </h2>
//           <p className="text-gray-700 text-lg mb-6">
//             Your profile is currently under review by the Health Consultation admin
//             team.
//           </p>
