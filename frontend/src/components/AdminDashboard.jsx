...
//                     className="bg-blue-600 hover:bg-blue-700 text-white text-xs px-3 py-1 rounded-md transition-all"
//                   >
//                     Approve
//                   </button>
//                 </td>
...
//             <h4 className="text-gray-700 mb-2">Appointments Over Time</h4>
...
//           <div className="bg-white p-4 rounded-lg shadow">
//             <h4 className="text-gray-700 mb-2">Doctor Specializations</h4>
//             <ResponsiveContainer width="100%" height={200}>
//               <PieChart>
//                 <Pie
...
//       {/* Sidebar */}
//      {/* Top Navbar */}
// <nav className="bg-blue-700 text-white flex flex-wrap items-center justify-between px-6 py-3 shadow-md">
//   <div className="flex items-center space-x-3">
//     <FaBars
//       onClick={() => setIsSidebarOpen(!isSidebarOpen)}
//       className="text-2xl cursor-pointer md:hidden"
//     />
//     <h2 className="text-xl font-bold">MediTrack Admin</h2>
//   </div>
...
//     className="bg-red-500 hover:bg-red-600 text-white px-4 py-1 rounded-md font-semibold text-sm transition"
//   >
//     Logout
//   </button>
// </nav>
...
//           <FaBars
//             onClick={() => setIsSidebarOpen(!isSidebarOpen)}
//             className="text-2xl text-blue-700 md:hidden cursor-pointer"
//           />
