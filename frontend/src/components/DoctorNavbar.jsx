...
//             className="ml-4 flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all"
//           >
//             <LogOut size={18} />
//             Logout
//           </button>
...
//                 className={({ isActive }) =>
//                   `flex items-center gap-3 text-[15px] font-medium p-2 rounded-lg transition-all ${
//                     isActive
...
//             <button
//               onClick={handleLogout}
//               className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all mt-3"
//             >
//               <LogOut size={18} />
//               Logout
//             </button>
